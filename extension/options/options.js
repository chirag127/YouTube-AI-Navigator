...
import { on, ge, l, e as er, vs, rt, url as gurl } from '../utils/shortcuts.js';
on(document, 'DOMContentLoaded', async () => {
    ...
    startSetupBtn && on(startSetupBtn, 'click', () => {
        chrome.tabs.create({ url: gurl('onboarding/onboarding.html') });
    });
    dismissBannerBtn && on(dismissBannerBtn, 'click', () => {
