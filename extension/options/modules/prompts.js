...
export class PromptsSettings {
  ...
  async init() {
    ...
    i('prompts-segments-intro-range').value = cfg.segments?.introDurationRange?.join(',') || '5,15';
    ...
    i('prompts-comprehensive-max-resources').value = cfg.comprehensive?.maxResourcesMentioned || 10;
  ...
  async save() {
    ...
    this.sm.set(
      ...
      Number(i('prompts-segments-timing').value)
    );
    ...
    this.sm.set(
      ...
      i('prompts-comments-sentiment').checked
    );
    this.sm.set(
