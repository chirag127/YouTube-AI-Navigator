...
describe('handleGenerateSummary', () => {
    let mockInitializeServices, mockGetServices, mockGetApiKey, mockFlr, mockAm, mockAjn, mockIsa, mockGemini, mockRsp;
    ...
    it('should generate summary successfully', async () => {
        const req = { transcript: [{ start: 10, text: 'Hello' }], settings: {}, metadata: { title: 'Title', author: 'Author' } };
