...
describe('handleChatWithVideo', () => {
    ...
    it('should chat with video successfully', async () => {
        const req = { question: 'What is this?', context: 'transcript', metadata: { title: 'Test', author: 'Channel' } };
        ...
        expect(mockGemini.chatWithVideo).toHaveBeenCalledWith('What is this?', expect.stringContaining('Test'), null);
