...
import { handleSaveHistory, handleGetVideoData } from '../../../extension/background/handlers/video-data.js';
...
describe('handleSaveHistory', () => {
    ...
    beforeEach(() => {
        ...
        mockGetHistory = vi.mocked(require('../../../extension/services/storage/comprehensive-history.js').getHistory);
...
describe('handleGetVideoData', () => {
    let mockSlg, mockSls, mockSlr, mockE, mockNw, mockHandleGetVideoInfo, mockHandleFetchTranscript, mockHandleAnalyzeComments;
    ...
    beforeEach(() => {
        ...
        mockHandleGetVideoInfo = vi.mocked(require('../../../extension/background/handlers/video-info.js').handleGetVideoInfo);
        mockHandleFetchTranscript = vi.mocked(require('../../../extension/background/handlers/fetch-transcript.js').handleFetchTranscript);
        mockHandleAnalyzeComments = vi.mocked(require('../../../extension/background/handlers/comments.js').handleAnalyzeComments);
        mockNw.mockReturnValue(1000000000);
    });

    it('should return cached data', async () => {
        const req = { videoId: 'vid1', dataType: 'metadata' };
        mockSlg.mockResolvedValue({ video_vid1_metadata: { version: 1, timestamp: 999999999, data: 'cached' } });
