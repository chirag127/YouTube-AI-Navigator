...
describe('init', () => {
    ...
    describe('initializeExtension', () => {
        it('should initialize successfully', async () => {
            ...
            const initObserver = (await import('../../../extension/content/core/observer.js')).initObserver;
            const autoLiker = (await import('../../../extension/content/features/auto-liker.js')).autoLiker;
        ...
        it('should handle autoLiker error', async () => {
            ...
            loadSettings.mockResolvedValue();
            const autoLiker = (await import('../../../extension/content/features/auto-liker.js')).autoLiker;
            autoLiker.init.mockImplementation(() => { throw new Error('autoLiker error'); });
    ...
    describe('waitForPageReady', () => {
        ...
        it('should handle error', async () => {
            Object.defineProperty(document, 'readyState', { value: 'loading', writable: true });
            const on = (await import('../../../extension/utils/shortcuts/dom.js')).on;
            on.mockImplementation(() => { throw new Error('dom error'); });
            const e = (await import('../../../extension/utils/shortcuts/log.js')).e;
